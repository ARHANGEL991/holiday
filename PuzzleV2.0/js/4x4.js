...
function showText() {
    ...
    for (counter = 0; counter < _len; counter++) {
        ...
        if (checkImage(puzzleImage,imagesArray[counter])) {
            $('div.windiv').remove();
            $('.winAnswer').append('<span class="windiv"><img src="' + puzzleImage + '"/></span>');
...
$(document).ready(function () {
    ...
    imagesArray = ["imagesPuzzles/bagach.jpg", 'imagesPuzzles/applespas.jpg', 'imagesPuzzles/dojinki.jpg', 'imagesPuzzles/kupalle.jpg', 'imagesPuzzles/maslenitsa.jpg', 'imagesPuzzles/pasha.jpg'];
    imagesMinArray = ["imagesPuzzlesMin/bagach.jpg", 'imagesPuzzlesMin/applespas.jpg', 'imagesPuzzlesMin/dojinki.jpg', 'imagesPuzzlesMin/kupalle.jpg', 'imagesPuzzlesMin/maslenitsa.jpg', 'imagesPuzzlesMin/pasha.jpg']; //миниатюры
